...
for file in os.listdir(os.getcwd()):
    if file.endswith('.mol2'):
        ...
        for i in ['0', '1']:
            try:
                name = file.split('.')[0]
                cav_name = name+'_S_SiH2_12_cyclic_Rh'+i+'_cavity.sdf'
                ...
                #properties = SMART_des.DBSTEP_Properties(struc, probe,int(i), prox_radius=5.0)
                for i in range(4, 16, 1):
                    rad = i/2
                    properties = SMART_des.get_all_properties(struc, probe, int(i), prox_radius=rad, alpha=0)
                ...
                continue
props.to_excel('S_SiH2_12_cyclic_RADII_2_8.xlsx')
